package com.example.administrator.imtest.service;
...
import com.example.administrator.imtest.util.AppManager;
...
public class WebSocketService extends Service {
    ...
    private Runnable heartBeatRunnable = new Runnable() {
        ...
        public void run() {
            if (System.currentTimeMillis() - sendTime >= HEART_BEAT_RATE) {
                boolean isSuccess = ConnectionHelper.checkIsConnected();
                if (!isSuccess) {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        try {
            ConnectionHelper.registerService();
    ...
    public void onDestroy() {
        ...
        if (messageReceiveListener != null) {
            ConnectionHelper.removeMessageReceiveListener(messageReceiveListener);
